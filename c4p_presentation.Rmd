...
[`tidycensus`](https://walkerke.github.io/tidycensus/) gives access to census API and makes it easy to plot data on a map.
...
WPRDC fire data
```{r eval=FALSE, include=FALSE}
pgh_fire_shp <- st_read("data/Allegheny_County_Census_Block_Groups_2016/Allegheny_County_Census_Block_Groups_2016.shp")
