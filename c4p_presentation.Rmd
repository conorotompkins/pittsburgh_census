...
We can use `st_intersection` to exclude all of the zip code polygons that do not fall within the `allegheny` county tibble we made earlier. Then, join the aggregated overdose data with `left_join`:
```{r}
