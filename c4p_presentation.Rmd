...
allegheny_erase <- st_erase(st_make_valid(allegheny), st_make_valid(allegheny_water))
```
```{r}
allegheny_erase %>% 
  ggplot(aes(fill = pct)) +
...
#need to add section about finding center of each polygon and adding the label with geom_label
```
